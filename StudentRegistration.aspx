<%@ Page Title="Student Registration" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StudentRegistration.aspx.cs" Inherits="StudentRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="col-sm-10" style="text-align:left;margin-top:2px;">
        ...
        <div class="col-sm-10">
             <asp:TextBox placeholder="Enter Your Enrollment Number" ID="txt_rollno" runat="server" class="form-control" required  MaxLength="8"></asp:TextBox>
        </div>
        </div>
       ...
       <div class="form-group"> <!--Degree-->
        ...
        <div class="col-sm-10 text-left">
            <asp:RadioButton ID="Cs" runat="server" GroupName="branch" Text="Computer Science"/>
